...
import { MenuItem,
  ...
  Switch,
    ...
    import { deleteTrafficligth } from '../../redux/trafficligthDucks';
...
const DeleteTrafficligthPage = () => {
  ...
  useEffect(()=>{
   ...
   const handleDelete =()=>{
    ...
    dispatch(deleteTrafficligth(state.Organization.code))
  }
    const navigate = useNavigate();
...
export default DeleteTrafficligthPage